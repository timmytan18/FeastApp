...
const LogIn = ({ navigation, route }) => {
    ...
    const verified = (route.params && route.params.phone) ? true : false;
    ...
    async function signIn() {
        ...
        try {
            ...
            if (err.code == 'UserNotConfirmedException') {
                navigation.navigate('Verification', { phone: phone, back: true })
        ...
        <DismissKeyboardView style={{ flex: 1 }}>
            <SafeAreaView style={styles.container}>
                <View>
                    ...
                    <PasswordInput onChange={changePassword} setPasswordInput={setPasswordInput} signIn={true} verified={verified} />
